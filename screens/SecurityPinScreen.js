...
import { Button, CustomText, ScreenHeader, PhoneInputWithFlag, Input, Keypad } from "../components";
import { colors, spacing } from "../utils";
import PinInput from "../components/PinInput";

const { width } = Dimensions.get("screen");

export const SecurityPinScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScreenHeader title="Set Your Security PIN" />
